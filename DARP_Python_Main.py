...
class DARP:
    def __init__(self,EnvironmentGrid,maxIter,dcells,cc,rl,Imp,show_grid=False):
...
if __name__ == "__main__":
    ...
    for sim in range(number_of_sims):
        ...
        dp = DARP(EnvironmentGrid,maxIter,dcells,cc,rl,Imp,False)
        dp.main_DARP()
        ...
        if(dp.abort == False):
            ...
            file_log.write(",")
            Astring = str(dp.Grid.reshape(1,dp.rows*dp.cols))
